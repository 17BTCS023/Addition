...
while(count<=100): # we want the dice to roll again and again, without writing the whole code again so we take the help of the called "while". and we define that the loop  is valid until the count reaches 100
    ...
    if(a=='r'): # here we compare our input "a" to the integer 'r', this r is written in quotes because we always compare two similar things. so r made to be an integer
        ...
        print("You are on the number", count)# this statement will tell the players position
